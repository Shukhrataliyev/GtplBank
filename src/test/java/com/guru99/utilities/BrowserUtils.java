...
public class BrowserUtils {
	...
	public static void scrollDown() {
		JavascriptExecutor jse = (JavascriptExecutor)Driver.getDriver(ConfigurationReader.getProperty("browser")); 
	...
	public static List<String> getElementsText(By locator) {
		...
		List<WebElement> elems = Driver.getDriver(ConfigurationReader.getProperty("browser")).findElements(locator);
		List<String> elemTexts = new ArrayList<>();
	...
	public static void switchToWindow(String targetTitle) {
		String origin = Driver.getDriver(ConfigurationReader.getProperty("browser")).getWindowHandle();
		for (String handle : Driver.getDriver(ConfigurationReader.getProperty("browser")).getWindowHandles()) {
			Driver.getDriver(ConfigurationReader.getProperty("browser")).switchTo().window(handle);
			if (Driver.getDriver(ConfigurationReader.getProperty("browser")).getTitle().equals(targetTitle)) {
				return;
			}
		}
		Driver.getDriver(ConfigurationReader.getProperty("browser")).switchTo().window(origin);
	}
